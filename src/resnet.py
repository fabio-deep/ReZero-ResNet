'''
ReZero ResNet unofficial implementation.
Rezero paper: https://arxiv.org/abs/2003.04887

ResNet based on: https://github.com/akamaster/pytorch_resnet_cifar10
'''
import torch
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, option='B', ReZero=False):
